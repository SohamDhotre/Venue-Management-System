...
<body>
  ...
  $q="insert into booking(venueid,vname,eid,ename,edate,start,end,requestedby,department,inchargeApproval,principalApproval) values('NMV3','VolleyBall Court','$eid','$ename','$date',$start,$end,'$username','$dept','pending','pending')";
  $res=$con->query($q);
  if($res)
  {
    echo "";
