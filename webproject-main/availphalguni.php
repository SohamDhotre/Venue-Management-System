...
<body>
  ...
  $q="insert into booking(venueid,vname,eid,ename,edate,start,end,requestedby,department,inchargeApproval,principalApproval) values('NMV5','CSE Seminar Hall','$eid','$ename','$date',$start,$end,'$username','$dept','pending','pending')";
  $res=$con->query($q);
  if($res)
  {
    echo "";
